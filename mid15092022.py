...
#	NoteOn(12, 0) >> Channel(16), fout la merde car il envoie sur le port launchkey mais ne reconecte pas le port fluidsynth
	Program(35) >> Channel(1),
	Program(13) >> Channel(2),
]
