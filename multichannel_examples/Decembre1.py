...
config(
        ...
        client_name='mididings',
			...
			('Launchkey MK3 49 LKMK3 DAW IN','16:1'),
        		('mididings_out1','128:0'),
			('mididings_out2','129:0'),
			('mididings_out3','130:0'),
			('mididings_out4','131:0') 	],
)
...
out1 = Output('mididings_out1', 1)  #channel 1 clavier principal on port 'FLUID synth
out2 = Output('mididings_out2', 2)  #talkbox
out3 = Output('mididings_out3', 3) #2em clavier si channelssplit
out4 = Output('mididings_out2', 4) #basse
out5 = Output('mididings_out3', 5) #pads
out6 = Output('mididings_out3', 6) #pads
out7 = Output('mididings_out3', 7) #pads
out8 = Output('mididings_out2', 8) #clavier basse 2em son
out10 = Output('mididings_out4', 10) #channel "10" percussions
...
#subprocess.run(['aconnect', '16:0', '132:0'])
#subprocess.run(['aconnect', '-d', '20:0', '132:1'])
...
scenes = {
	...
	80: Scene("smode0", synthrun, init_patch=synthsetup0),
	81: Scene("smode1", synthrun, init_patch=synthsetup1),
	82: Scene("smode2", synthrun, init_patch=synthsetup2),
	83: Scene("smode3", synthrun, init_patch=synthsetup3),
	84: Scene("smode4", synthrun, init_patch=synthsetup4),
	85: Scene("smode5", synthrun, init_patch=synthsetup5),
	86: Scene("smode6", synthrun, init_patch=synthsetup6),
	87: Scene("smode7", synthrun, init_patch=synthsetup7),
	88: Scene("smode8", synthrun, init_patch=synthsetup8),
	89: Scene("smode9", synthrun, init_patch=synthsetup9),
	90: Scene("smode0", synthrun, init_patch=synthsetup10),
	91: Scene("smode1", synthrun, init_patch=synthsetup11),
	92: Scene("smode2", synthrun, init_patch=synthsetup12),
	93: Scene("smode3", synthrun, init_patch=synthsetup13),
	94: Scene("smode4", synthrun, init_patch=synthsetup14),
	95: Scene("smode5", synthrun, init_patch=synthsetup15),
	96: Scene("smode6", synthrun, init_patch=synthsetup16),
	97: Scene("smode7", synthrun, init_patch=synthsetup17),
	98: Scene("smode8", synthrun, init_patch=synthsetup18),
