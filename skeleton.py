...
# in patches.
spam1 = Output('LaunchkeyI', 1)               # channel 1 on port 'spam'
spam2 = Output('LaunchkeyI', 2)               # channel 2 on port 'spam'
ham1  = OutputTemplate('FLUID', 1, None)  # channel 1 on port 'ham'
eggs1 = OutputTemplate('FLUID', 1, 23)   # channel 1, program 23 on port 'eggs'
eggs2 = OutputTemplate('FLUID', 1, 42)   # channel 1, program 42 on port 'eggs'
